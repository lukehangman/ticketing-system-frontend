  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 p-6">
        <div className="max-w-4xl mx-auto h-[calc(100vh-200px)] flex flex-col bg-white rounded-xl shadow-md dark:bg-gray-800">
              ...
              <div key={msg._id} className={`flex ${msg.sender?._id === currentUserId ? 'justify-end' : 'justify-start'}`}>
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    <span className="font-medium text-sm">{msg.sender?.name || t('chat.unknown')}</span>
